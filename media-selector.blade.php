<div class="w-full h-full">
    ...
    <div x-data="{
            ...
            emoji: @entangle('emoji').defer,
            image_string: @entangle('image_string').defer,
            image_upload_url: '',
            submit_processing: @entangle('submit_processing').defer,
        ...
        @if(in_array('emoji', $sections))
            {{-- Main Content Area --}}
            <div x-show="section=='emoji'" class="relative flex items-center justify-center w-full h-auto p-0">
